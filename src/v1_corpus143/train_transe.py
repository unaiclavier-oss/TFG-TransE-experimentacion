"""
Pipeline de entrenamiento de TransE para la Sección 3 del TFG.
Pasos ②–⑤ del montaje experimental:
    ...
    ⑤  Bucle de entrenamiento        (muestreo negativo + Margin Ranking Loss + Adam)

Entrada : dataset/kg_geografia_historia.csv   (head,relation,tail)
Salidas : transe_run/   (mapeos, splits, embeddings entrenados, histórico de pérdida)

La evaluación cualitativa (curva de pérdida, t-SNE/PCA, aritmética vectorial) es el
...
DATA_CSV   = ROOT / "dataset" / "kg_geografia_historia.csv"
OUTPUT_DIR = ROOT / "transe_run"
OUTPUT_DIR.mkdir(parents=True, exist_ok=True)

# ---- Hiperparámetros (tabla de §3.3; se afinan por validación en el paso ⑥) ----
EMB_DIM    = 50      # d  : dimensión del espacio latente
MARGIN     = 1.0     # γ  : margen de la Margin Ranking Loss (valor seleccionado por validación, §3.3)
